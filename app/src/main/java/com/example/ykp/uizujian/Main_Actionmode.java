...
public class Main_Actionmode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__actionmode);
        ...
        datachange();
        list=getData();
        adapter=new SimpleAdapter(Main_Actionmode.this,list,R.layout.actionmode_unit,key,id);
